           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a  href="<?php echo e(url('/Jabatan')); ?>"><i class="fa fa-qrcode fa-3x"></i>Jabatan</a>
                    </li>
                      <li  >
                        <a  href="<?php echo e(url('/Golongan')); ?>"><i class="fa fa-qrcode fa-3x"></i>Golongan</a>
                    </li>
                    <li  >
                        <a  href="<?php echo e(url('/KategoriLembur')); ?>"><i class="fa fa-qrcode fa-3x"></i> Kategori Lembur </a>
                    </li>
                    <li  >
                        <a  href="<?php echo e(url('/Tunjangan')); ?>"><i class="fa fa-qrcode fa-3x"></i> Tunjangan </a>
                    </li>               
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo e(url('/gajian')); ?>">Gaji Pegawai</a>
                            </li>
                        </ul>
                      </li>  
                  <li>
