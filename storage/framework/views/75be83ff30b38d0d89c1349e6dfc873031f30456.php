    ...
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group<?php echo e($errors->has('kode_tunjangan') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="kode_tunjangan" type="kode_tunjangan" class="form-control" placeholder="PLease Enter Keyword" name="kode_tunjangan" value="<?php echo e(old('kode_tunjangan')); ?>" required autofocus>
                    ...
                    <div class="form-group<?php echo e($errors->has('jumlah_anak') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="jumlah_anak" type="jumlah_anak" class="form-control" name="jumlah_anak" value="<?php echo e(old('jumlah_anak')); ?>" required autofocus>
