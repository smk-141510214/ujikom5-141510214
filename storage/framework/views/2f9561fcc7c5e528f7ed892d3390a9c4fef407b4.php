    ...
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group<?php echo e($errors->has('kode_jabatan') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="kode_jabatan" type="kode_jabatan" class="form-control" name="kode_jabatan" placeholder="PLease Enter Keyword" value="<?php echo e(old('kode_jabatan')); ?>" required autofocus>
                    ...
                    <div class="form-group<?php echo e($errors->has('nama_jabatan') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="nama_jabatan" type="nama_jabatan" class="form-control" name="nama_jabatan" placeholder="PLease Enter Keyword" value="<?php echo e(old('nama_jabatan')); ?>" required autofocus>
                    ...
                    <div class="form-group<?php echo e($errors->has('besaran_uang') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input id="besaran_uang" type="besaran_uang" class="form-control" name="besaran_uang" placeholder="PLease Enter Keyword" value="<?php echo e(old('besaran_uang')); ?>" required autofocus>
